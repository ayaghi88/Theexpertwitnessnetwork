      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          <div className="flex items-center">
            <Scale className={`h-8 w-8 ${scrolled ? 'text-emerald-900' : 'text-gold-400'}`} />
            <span className={`ml-2 text-xl font-serif font-bold tracking-tight ${scrolled ? 'text-emerald-900' : 'text-white'}`}>
            ...
            <div className="ml-10 flex items-baseline space-x-8">
              {navLinks.map((link) => (
                <a
                  key={link.name}
                  href={link.href}
                  className={`text-sm font-medium transition-colors hover:text-gold-500 ${scrolled ? 'text-emerald-900' : 'text-white'}`}
                >
                  {link.name}
                </a>
              ))}
          ...
          <div className="md:hidden">
            <button
              ...
              className={`${scrolled ? 'text-emerald-900' : 'text-white'} p-2`}
            >
        ...
        <div className="grid md:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-4 text-emerald-50/60">
              ...
              <li><a href="#practice-areas" className="hover:text-gold-500 transition-colors">Practice Areas</a></li>
